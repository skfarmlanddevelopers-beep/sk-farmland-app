...
export default function Gallery({ onBookClick }: GalleryProps) {
  ...
  const combinedGalleryData = [...dynamicGallery, ...galleryData];
        ...
        {selectedImage && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
              ...
              className="relative max-w-5xl w-full bg-black rounded-2xl overflow-hidden shadow-2xl z-10 flex items-center justify-center"
            >
              {/* Close Button */}
              <button
                onClick={() => setSelectedImage(null)}
