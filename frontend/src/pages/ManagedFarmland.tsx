...
export default function ManagedFarmland({ onBookClick }: ManagedFarmlandProps) {
  ...
  return (
    ...
    >
      ...
      <section id="what-is-managed" className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4">
      ...
      <section id="managed-infrastructure" className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <motion.div 
            ...
            className="bg-[#0A0A0A] border-2 border-orange-600 hover:border-orange-500 transition-colors rounded-2xl p-6 flex flex-col justify-between space-y-6"
          >
      ...
      <section id="charges-and-usage" className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section id="income-and-reasons" className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <section id="managed-cta" className="mx-auto max-w-4xl xl:max-w-6xl 2xl:max-w-7xl px-4 text-center mt-8">
        <div className="p-6 rounded-2xl bg-zinc-950 border-2 border-orange-600 hover:border-orange-500 transition-colors space-y-4">
          ...
          <p className="text-xs text-zinc-400 leading-relaxed max-w-xl mx-auto">
            Enquire today. Our legal advocates, soil specialists, and layout engineers are present to walk you through plots and answer legal/taxation queries.
          </p>
