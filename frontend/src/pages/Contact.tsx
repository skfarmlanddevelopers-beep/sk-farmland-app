...
export default function Contact({ onBookClick }: ContactProps) {
  ...
  return (
    ...
    >
      ...
      {/* Header */}
      <section id="contact-hero" className="text-center space-y-4 max-w-3xl xl:max-w-5xl 2xl:max-w-6xl mx-auto px-4">
      ...
      <motion.section 
        ...
        id="contact-form-section" className="mx-auto max-w-5xl xl:max-w-6xl 2xl:max-w-7xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12"
      >
