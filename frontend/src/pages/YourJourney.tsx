...
export default function YourJourney({ onBookClick }: YourJourneyProps) {
  const values = [
    ...
    },
    {
      ...
      desc: 'Our team works closely with you throughout the process—from enquiry to registration—ensuring a smooth and hassle-free experience.',
  ...
  return (
    ...
    >
      ...
      {/* Header / Hero */}
      <section id="journey-hero" className="text-center space-y-4 max-w-3xl xl:max-w-5xl 2xl:max-w-6xl mx-auto px-4">
      ...
      <section id="journey-timeline" className="mx-auto max-w-4xl xl:max-w-6xl 2xl:max-w-7xl px-4 relative">
      ...
      <section id="journey-cta" className="mx-auto max-w-4xl xl:max-w-6xl 2xl:max-w-7xl px-4 text-center">
