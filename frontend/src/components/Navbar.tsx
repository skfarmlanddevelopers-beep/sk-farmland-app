            ...
            {menuItems.map((item) => {
              ...
              return (
                <button
                  ...
                  className={`relative px-1.5 py-1.5 rounded-lg text-[10px] xl:text-[11px] 2xl:text-[13px] 2xl:px-2 font-bold tracking-wide transition-colors duration-300 cursor-pointer whitespace-nowrap ${
